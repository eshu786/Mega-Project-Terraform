...
resource "aws_eks_cluster" "devopsshack_prod" {
  name     = "devopsshack-cluster-prod"
...
# EKS Addon
resource "aws_eks_addon" "ebs_csi_driver_prod" {
  cluster_name    = aws_eks_cluster.devopsshack_prod.name
...
# EKS Node Group for PROD
resource "aws_eks_node_group" "devopsshack_prod" {
  cluster_name    = aws_eks_cluster.devopsshack_prod.name
  node_group_name = "devopsshack-node-group-prod"
